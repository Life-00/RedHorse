...
**Rhythm Fairy**는 교대근무자의 건강한 생활 리듬을 지원하는 AI 기반 웰니스 플랫폼입니다. AWS Bedrock Agent와 생체리듬 분석 알고리즘을 활용하여 개인 맞춤형 수면·카페인·피로 관리 솔루션을 제공합니다.
